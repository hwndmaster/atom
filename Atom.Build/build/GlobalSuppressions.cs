...
[assembly: SuppressMessage("", "S112:General or reserved exceptions should never be thrown", Justification = "Let me decide when to do that")]
[assembly: SuppressMessage("", "S127:\"for\" loop stop conditions should be invariant", Justification = "WAT? Some algorithms need this")]
[assembly: SuppressMessage("", "S1066:Mergeable \"if\" statements should be combined", Justification = "Leave it alone, for readability")]
[assembly: SuppressMessage("", "S1121:Assignments should not be made from within sub-expressions", Justification = "I like them more than I hate them")]
[assembly: SuppressMessage("", "S2346:Flags enumerations zero-value members should be named \"None\"", Justification = "We use 'Unknown' instead")]
